...
function formSubmission(
  ...
  let launchStatus = document.getElementById("launchStatus").textContent;
  fuelLevelValue = Number(document.getElementsByName("fuelLevel")[0].value);
  cargoLevelValue = Number(cargoLevelValue);
  ...
  if (
    ...
    if (fuelLevelValue < 10000 && Number(cargoLevelValue) > 10000) {
